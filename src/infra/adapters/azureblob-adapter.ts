...
import { IUploadProvider } from '@application/ports/IUploadProviderAdapter';
...
export default class AzureBlobAdapter implements IUploadProvider {
  ...
  private readonly containerName: string = process.env.AZURE_BLOB_CONTAINER_NAME ?? 'productsphoto';
